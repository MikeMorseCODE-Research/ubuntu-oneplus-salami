...
$1/mkbootimg --header_version 4 --base 0x0 --os_version 15.0.0 --os_patch_level 2025-02 --kernel $1/linux/Image_w_dtb.gz --cmdline "earlycon=msm_geni_serial,0x994000 console=ttyMSM0,115200n8 rw loglevel=8 androidboot.selinux=permissive" -o $1/boot_salami_8G.img
cd $1
rm -rf linux
